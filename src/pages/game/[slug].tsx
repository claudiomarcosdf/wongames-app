...
export default function Index(props: GameTemplateProps) {
  ...
  //se a rota não tiver sido gerada ainda pode mostrar um loading
...
export async function getStaticPaths() {
  const { data } = await apolloClient.query<QueryGames, QueryGamesVariables>({
    query: QUERY_GAMES,
    variables: { limit: 15 } //gera apenas 15 paths junto com o carregamento das páginas
  })
...
//GERA A PÁGINA - preenche os dados
